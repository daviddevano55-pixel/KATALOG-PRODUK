    ...
    <div className="p-10 max-w-7xl mx-auto space-y-8">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => // Cek apakah user adalah admin
if (!adminEmails.includes(currentUser?.email)) return alert("Anda bukan admin!");
            setView("admin")} className="rounded-2xl">Admin</Button>
